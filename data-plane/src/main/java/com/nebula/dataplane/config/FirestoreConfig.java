...
/**
 * Configuration for Google Cloud Firestore in Data Plane
 */
@Configuration
public class FirestoreConfig {
    ...
    public Firestore firestore() throws IOException {
        logger.info("Initializing Firestore for Data Plane with project ID: {} and database ID: {}", projectId, databaseId);
        ...
        logger.info("Firestore initialized successfully for Data Plane");
        return firestore;
    }
}