...
public class ExecutionPlan {
    ...
    public ExecutionFlow getExecutionFlow() { return executionFlow; }
    public void setExecutionFlow(ExecutionFlow executionFlow) { this.executionFlow = executionFlow; }
    ...
    public HumanInTheLoop getHumanInTheLoop() { return humanInTheLoop; }
    public void setHumanInTheLoop(HumanInTheLoop humanInTheLoop) { this.humanInTheLoop = humanInTheLoop; }
    ...
    public static class HumanInTheLoop {
        ...
        public void setTeamsIntegration(TeamsIntegration teamsIntegration) { this.teamsIntegration = teamsIntegration; }
        ...
        public static class TeamsIntegration {
            ...
            public Boolean getSpeechToText() { return speechToText; }
            public void setSpeechToText(Boolean speechToText) { this.speechToText = speechToText; }
            
            public Boolean getTextToSpeech() { return textToSpeech; }
